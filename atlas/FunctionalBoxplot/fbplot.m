...
function [depth, outpoint, medianCurveId, posPercentile, centralRegionId]=fbplot(data,x,depth,method,show,prob,color,outliercol,barcol,fullout,factor,sampleData)
